...
Want to rebuild this entire project from scratch using Copilot? Paste the prompt below into GitHub Copilot **Agent mode** and watch it generate the full-stack app:
